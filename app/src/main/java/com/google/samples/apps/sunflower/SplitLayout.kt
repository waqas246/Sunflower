...
import com.google.samples.apps.sunflower.databinding.*
...
class SplitLayout : FrameLayout {
    ...
    private lateinit var tentGarden1: TentGardenBinding
    private lateinit var plantList: FragmentPlantListBinding
    ...
    override fun onAttachedToWindow() {
        ...
        tentGarden1 = DataBindingUtil.findBinding(findViewById(R.id.tentGarden))!!
        plantList = DataBindingUtil.findBinding(findViewById(R.id.plantList))!!
    }

    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        if (windowLayoutInfo == null) return

        val splitPositions = splitViewPositions(tentGarden1.root, plantList.root)
        ...
        if (splitPositions != null) {
            ...
            tentGarden1.root.measure(startWidthSpec, startHeightSpec)
            tentGarden1.root.layout(
            ...
            plantList.root.measure(endWidthSpec, endHeightSpec)
            plantList.root.layout(
